...
import PowerProfilectl from '../../services/powerprofilectl.js';
import Indicator from '../../services/onScreenIndicator.js';
import icons from '../../icons.js';
import FontIcon from '../../misc/FontIcon.js';

const ProfileIndicator = () => Widget.Icon({
    connections: [[PowerProfilectl, icon => {
        icon.visible = PowerProfilectl.profile !== 'Balanced';
        icon.icon = icons.powerprofilectl.profile[PowerProfilectl.profile];
    }]],
});
...
export default () => PanelButton({
    ...
    child: Widget.Box({
        children: [
            PowerProfilectl?.available && ProfileIndicator(),
            DNDIndicator(),
